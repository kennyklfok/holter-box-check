...
await writeFile('public/website-qr.svg', svg, 'utf8');
console.log('Created qr-poster.html and public/website-qr.svg. Open the poster in a browser and print at 100% scale.');
